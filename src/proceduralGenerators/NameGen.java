...
public class NameGen {
	...
	final private static char[] consonants = {'b', 'c', 'd','f','g','h','j','k', 'l','m','n','p','q','r', 's', 't', 'v', 'w', 'x', 'y','z','ç'};
	 ...
	 * @throws IOException
	 */
	public NameGen(String fileName,double sd) throws IOException{
		this.seed = sd;
	...
	public String compose(int syls){
		...
		String name;
		int a = (int)(proceduralGenerators.Seeder.getDecimalNum(seed) * pre.size());
		...
		for(int i = 0; i<b.length-2; i++){
			...
			do{
				b[i] = (int)(proceduralGenerators.Seeder.getDecimalNum(seed) * mid.size());
		...
		int c;
		do{
			c = (int)(proceduralGenerators.Seeder.getDecimalNum(seed) * sur.size());					
		}			
